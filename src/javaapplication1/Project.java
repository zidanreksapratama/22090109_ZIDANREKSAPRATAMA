...
public class Project extends javax.swing.JFrame {
    ...
    private void Tampil(String Sql) {
        ...
        kolomkolom.addColumn("ID Absensi QR");
        kolomkolom.addColumn("Nama Karyawan");
        kolomkolom.addColumn("Tanggal dan Waktu Absensi");
        kolomkolom.addColumn("Keterangan");
        kolomkolom.addColumn("Data QR");
    ...
    private void initComponents() {
        ...
        Tabeldata.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Absensi QR", "Nama Karyawan", "Tanggal dan Waktu Absensi", "Keterangan", "Data QR"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       Tampil(Sql);   // TODO add your handling code here:
